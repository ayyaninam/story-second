...
export interface paths {
  ...
  "/api/Payment/CreateSubscription": {
    ...
    post: {
      requestBody?: {
        content: {
          "application/json-patch+json": components["schemas"]["SubscriptionDTO"];
  ...
  "/api/Payment/UpgradeSubscription": {
    /** Create a subscription for the user. */
    post: {
      requestBody?: {
        content: {
  ...
  "/api/User/RedeemPromo": {
    /** Redeem a promo code. */
    post: {
      requestBody?: {
        content: {
          "application/json-patch+json": components["schemas"]["RedeemPromoDTO"];
          "application/json": components["schemas"]["RedeemPromoDTO"];
          "text/json": components["schemas"]["RedeemPromoDTO"];
          "application/*+json": components["schemas"]["RedeemPromoDTO"];
        };
      };
      responses: {
  ...
  "/api/WebStory/UploadBackgroundAudio/{id}": {
    /** Upload background audio for a story. */
    post: {
      parameters: {
        path: {
          id: string;
...
export interface components {
  schemas: {
    ...
    /** @description DTO used to redeem a promo code. */
    RedeemPromoDTO: {
     ...
     * @enum {integer}
     */
    SubscriptionPlan: Free | Starter | Creator | Professional | Custom;
    ...
    UserAccount: {
      ...
      userAudios?: components["schemas"]["UserAudio"][] | null;
    };
    UserAllowance: {
      /** Format: uuid */
      id?: string;
    ...
    WebStory: {
      ...
      webStoryAudios?: components["schemas"]["WebStoryAudio"][] | null;
    };
    WebStoryAudio: {
      /** Format: uuid */
      id?: string;
      ...
      /** Format: uuid */
      userAudioId?: string;
      userAudio?: components["schemas"]["UserAudio"];
    };
    WebStoryAudioDTO: {
      name?: string | null;
      audioKey?: string | null;
