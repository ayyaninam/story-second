...
export interface components {
	schemas: {
		...
		EditSceneOperation: {
			...
			/** Details */
			details:
				| components["schemas"]["SceneEdit"]
				| components["schemas"]["SceneAdd"]
				| components["schemas"]["SceneDelete"]
				| null;
		};
		/** EditSceneRequest */
		EditSceneRequest: {
		...
		EditSegmentOperation: {
			...
			/** Details */
			details:
				| components["schemas"]["SegmentEdit"]
				| components["schemas"]["SegmentAdd"]
				| components["schemas"]["SegmentDelete"]
				| null;
		};
		/** EditSegmentRequest */
		EditSegmentRequest: {
