...
export interface paths {
	...
	"/api/Library/Story/{id}": {
		/**
		 * Get one public story by id
		 * @description Get a single public story by its ID
		 */
	...
	"/api/Library/ShortId/{shortId}": {
		/**
		 * Get one public story by short id
		 * @description Get a single public story by its short id
		 */
		get: operations["GetOnePublicStoryByShortId"];
	};
	...
	"/api/TextToSpeech/GetGenericAudio/{id}": {
		/**
		 * Get Generated audio
		 * @description Generate a new audio using generic voice IDs
		 */
		get: operations["GenerateGenericAudio"];
	};
...
export interface components {
	schemas: {
		...
		/**
		 * Format: int32
		 * @description The gender of a child that a story is for.
		 * @enum {integer}
		 */
		...
		/**
		 * Format: int32
		 * @description Represents the lifecycle state of a podcast.
		 * @enum {integer}
		 */
		PodcastLifecycle: Requested | Processing | Publishing | Published | Error;
		/**
		 * Format: int32
		 * @description Represents the requested voice type of a podcast.
		 * @enum {integer}
		 */
		PodcastVoiceType: GenericMale | GenericFemale;
		PromptResponse: {
			prompt?: string | null;
		};
		...
		ReturnAdminSmallWebStoryDTO: {
			...
			/**
			 * ShortId
			 * @description The short ID of the WebStory.
			 */
			shortId?: string | null;
			/**
			 * StoryTitle
		...
		/** @description Admin panel StoryPodcast object. */
		ReturnAdminStoryPodcastDTO: {
			/**
			 * Created
			 * Format: date-time
			 * @description The date the StoryPodcast was requested.
			 */
			created?: string;
			/**
			 * AppleLink
			 * @description The Apple link of the StoryPodcast.
			 */
			appleLink?: string | null;
			/**
			 * SpotifyLink
			 * @description The Spotify link of the StoryPodcast.
			 */
			spotifyLink?: string | null;
			podcastLifecycle?: components["schemas"]["PodcastLifecycle"];
			voiceType?: components["schemas"]["PodcastVoiceType"];
		};
		...
		ReturnAdminWebStoryDTO: {
			...
			storyComments?:
				...
				| null;
			storyPodcast?: components["schemas"]["ReturnAdminStoryPodcastDTO"];
			...
			webStoryData?: components["schemas"]["ReturnAdminWebStoryDataDTO"];
		...
		/** @description Admin panel WebStoryData object. */
		ReturnAdminWebStoryDataDTO: {
			/**
			 * ChildName
			 * @description The name of the child the WebStory is for.
			 */
			 ...
			 * ChildAge
			 * Format: int32
			 * @description The age of the child the WebStory is for.
			 */
			childAge?: number;
			/**
			 * TopicOne
			 * @description The first topic of the WebStory.
			 */
			topicOne?: string | null;
			/**
			 * TopicTwo
			 * @description The second topic of the WebStory.
			 */
			topicTwo?: string | null;
			/**
			 * TopicThree
			 * @description The third topic of the WebStory.
			 */
			topicThree?: string | null;
			/**
			 * LocationName
			 * @description The location name of the WebStory.
			 */
		...
		ReturnOwnWebStoryDTO: {
			...
			/**
			 * ShortId
			 * @description The short id of the story.
			 */
			shortId?: string | null;
			/**
			 * IsPublic
			...
			storyPodcast?: components["schemas"]["ReturnStoryPodcastDTO"];
		...
		ReturnStoryPodcastDTO: {
			...
			/** Format: float */
			finalAudioDuration?: number | null;
			appleLink?: string | null;
			spotifyLink?: string | null;
			podcastLifecycle?: components["schemas"]["PodcastLifecycle"];
			voiceType?: components["schemas"]["PodcastVoiceType"];
