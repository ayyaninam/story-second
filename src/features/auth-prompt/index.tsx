...
function PreLoginMobile({ onLogIn, onSignUp }: PreLoginProps) {
	return (
		<div
		...
		>
			<div className="p-1">
				...
				>
					<g clip-path="url(#clip0_1583_8146)">
						<mask
							id="mask0_1583_8146"
...
export default function PreLogin() {
	...
	const onSignUp = () => router.push("/api/auth/signup");

	if (isMobile) return <PreLoginMobile onLogIn={onLogIn} onSignUp={onSignUp} />;
	return (
		<div
