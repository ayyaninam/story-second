		...
		<div className="w-full flex items-center justify-center gap-2 pb-6">
			...
			>
				<div className="pt-8 pb-16 flex pr-6 pl-10 gap-8 flex-col items-start w-full">
					<span className="flex py-1 px-2 bg-teal-50 rounded-[350px] text-indigo-600 font-normal tracking-tighter text-sm">
						Hi There
					</span>
					<div className="flex flex-col gap-4 items-start">
						...
						<p className="text-base font-normal text-indigo-700">
					...
					<div className="flex gap-4 flex-col sm:flex-row">
						<Button
							variant="secondary"
							size="sm"
							className="bg-indigo-600 hover:bg-indigo-700 flex gap-1.5 py-1.5 px-2.5 text-sm font-medium items-center h-fit border border-indigo-700 text-background"
							onClick={() => {
				...
				<div className="w-full min-h-full bg-indigo-700 self-stretch">
