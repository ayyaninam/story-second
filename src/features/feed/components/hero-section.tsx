		...
		<div className="w-full flex items-center justify-center gap-2 pb-6">
			...
			>
				<div className="pt-8 pb-16 flex pr-6 pl-10 gap-8 flex-col items-start w-full">
					<span className="flex py-1 px-2 bg-teal-50 rounded-[350px] text-accent-600 font-normal tracking-tighter text-sm">
						Hi There
					</span>
				...
				<div className="w-full min-h-full bg-accent-700 self-stretch">
