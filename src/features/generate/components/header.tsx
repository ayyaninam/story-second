      ...
      >
        <div className="flex items-start w-[250px]">
          <div style={{width: 32, height: 32, position: 'relative', boxShadow: '0px 2.999999761581421px 10.999999046325684px rgba(54.89, 55.76, 117.32, 0.12)'}}>
            <div style={{width: 32, height: 32, left: 0, top: 0, position: 'absolute', background: 'linear-gradient(0deg, #8F22CE 0%, #8F22CE 100%), linear-gradient(180deg, rgba(255, 255, 255, 0.12) 0%, rgba(255, 255, 255, 0) 100%)', boxShadow: '0px -0.800000011920929px 9.600000381469727px rgba(255, 255, 255, 0.12) inset', borderRadius: 8}} />
            ...
            <div style={{width: 28, height: 28, left: 2, top: 2, position: 'absolute', background: '#3E095D', boxShadow: '0px 0.2499999850988388px 0.9999999403953552px rgba(0, 0, 0, 0.25) inset', borderRadius: 9999, border: '0.40px #7521A6 solid'}} />
            <div style={{width: 19, height: 19, left: 6, top: 6, position: 'absolute', boxShadow: '0px 1.600000023841858px 3.200000047683716px #5C0C8A'}}>
              <div style={{width: 19, height: 19, left: 0, top: 0, position: 'absolute'}} />
              <div style={{width: 21, height: 21, left: -1, top: -1, position: 'absolute'}} />
              <div style={{width: 24, height: 24, padding: 3, left: -2, top: -2, position: 'absolute', justifyContent: 'center', alignItems: 'center', display: 'inline-flex'}}>
                <GenerateIcon />
              </div>
            </div>
          </div>
