...
import {AspectRatios, DisplayAspectRatios, StoryLanguages, StoryLengths, StoryOutputTypes} from "@/utils/enums";
...
export const tabs = [
  ...
  },
  {
    ...
    description: (
      <span className="font-normal text-xs text-slate-600">
				Write a short prompt to describe the{" "}
        <span className="font-medium text-slate-950">storybook</span> you want to
				imagine.
			</span>
    ),
...
export const videoRatios = [
  { value: "16:9", icon: <WideOrientationIcon />, enumValue: DisplayAspectRatios["1024x576"] },
  { value: "9:16", icon: <VerticalOrientationIcon />, enumValue: DisplayAspectRatios["576x1024"] },
  { value: "1:1", icon: <BookOrientationIcon />, enumValue: DisplayAspectRatios["1024x1024"] },
];