...
export const LibraryHeader = ({
	...
	return (
		...
		>
			...
			>
				<div className="flex justify-between items-center px-[20px] py-[14px] w-full">
					<div className="flex items-start w-[250px]">
						...
						<div className="pl-[12px] flex flex-col items-start">
							...
							<span className="text-teal-700 text-sm font-normal">
								17 Videos
							</span>
						</div>
					</div>
			...
			>
				<div className="w-[400px] flex h-[40px] gap-2 items-center">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						width="20"
						height="20"
