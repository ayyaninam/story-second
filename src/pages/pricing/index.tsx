// from this: https://shipixen.com/shadcn-pricing-page
...
export const tiers: PricingTier[] = [
	...
	},
	{
		...
		price: { "1": "$800", "2": "$2500" },
		discountPrice: { "1": "", "2": "" },
		description: `Maximum power and flexibility for large-scale content generation needs.`,
		features: [
			`175 videos / month`,
			`350 stories / month`,
			`Fast Generation Time`,
			`$5 for extra video, $1 for extra story`,
			`Dedicated support`,
		],
		featured: true,
		highlighted: true,
